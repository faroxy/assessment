...
const assesmentBotton = document.getElementById('assesment');
 ...
 */
function removeAllChilderen(element){
...
assesmentBotton.onclick = () => {
    ...
    //TODO診断結果の表示エリア
    removeAllChilderen(resultDivded);
   ...
   //TODOツイートエリアの作成
   removeAllChilderen(tweetDivided);
